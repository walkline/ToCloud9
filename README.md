...
| Auction house in cluster support                              | ✅	      |                                                                                                                	                                                                                                                 |
| Friends list in cluster support                               | ✅	      |                                                                                                                	                                                                                                                 |
| Global channels in cluster support                            | ✅	      |                                                                                                                	                                                                                                                 |
| Parties and raids in cluster support                          | 90%	    | **Not implemented:** <br/>ready checks, instances reset on player request, <br/>prolonging instance bind, <br/>moving raid members between groups |
